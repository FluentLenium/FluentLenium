...
public class MultiScenarioMultiStep2 extends FluentCucumberAdapter {
    ...
    public MultiScenarioMultiStep2(MultiScenarioInitialStep initialStep) {
        this.initialStep = initialStep;
    }

    @When(value = "multiscenario multi2 I click on next page")
    public void step2() {
    ...
    @Then(value = "multiscenario multi2 I am on the second page")
    public void step3() {
        this.initFluentWithWebDriver(initialStep);
        this.initTest();
