...
import fr.javafreelance.fluentlenium.filter.FilterType;
import fr.javafreelance.fluentlenium.filter.matcher.EqualMatcher;
import fr.javafreelance.fluentlenium.filter.matcher.Matcher;
import fr.javafreelance.fluentlenium.filter.matcher.NotContainsMatcher;
