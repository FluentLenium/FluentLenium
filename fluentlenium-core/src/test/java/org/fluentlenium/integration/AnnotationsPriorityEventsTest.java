...
public class AnnotationsPriorityEventsTest extends IntegrationFluentTest {
    ...
    @BeforeClickOn(2)
    private void beforeClickOn2(FluentWebElement element) {
        beforeClick.add(2);
    }

    @BeforeClickOn(1)
    private void beforeClickOn1(FluentWebElement element) {
        beforeClick.add(1);
    }

    @BeforeClickOn(5)
    private void beforeClickOn5(FluentWebElement element) {
        beforeClick.add(5);
    }

    @BeforeClickOn(-2)
    private void beforeClickOnNeg2(FluentWebElement element) {
        beforeClick.add(-2);
    }
