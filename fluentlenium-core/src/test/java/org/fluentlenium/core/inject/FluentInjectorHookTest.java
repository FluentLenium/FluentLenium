...
public class FluentInjectorHookTest {
    ...
    public static class NanoHook2 extends NanoHook {
        public NanoHook2(FluentControl fluentControl, ComponentInstantiator instantiator,
    ...
    public void testFluentWebElementClass() { // NOPMD ExcessiveMethodLength
        ...
        LocatorHandler subInjectedMethodNoHookHandler = LocatorProxies
        ...
        WebElementWrapper subInjectedMethodNoHook2 = container.subContainer.subContainer2.find("#subInjectedMethod")
                .noHook().first().as(WebElementWrapper.class);
        LocatorProxies.now(subInjectedMethodNoHook2.getElement());

        LocatorHandler subInjectedMethodNoHook2Handler = LocatorProxies
