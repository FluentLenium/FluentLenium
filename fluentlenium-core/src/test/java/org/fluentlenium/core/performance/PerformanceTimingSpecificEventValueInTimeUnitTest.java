...
public class PerformanceTimingSpecificEventValueInTimeUnitTest {
    ...
    private static final Map<String, BiFunction<DefaultPerformanceTiming, TimeUnit, Long>> EVENT_CALLS = new ImmutableMap.Builder<String, BiFunction<DefaultPerformanceTiming, TimeUnit, Long>>()
