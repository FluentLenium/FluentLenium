...
public class HookControlTest {
    ...
    public void before() throws NoSuchFieldException, IllegalAccessException {
        hookControl = Mockito.spy(new HookControlImpl<>(null, proxy, control, instantiator, supplier));
        ...
        when(supplier.get()).thenAnswer((Answer<HookControlImpl>) invocation -> {
            HookControlImpl<HookControl> answer = Mockito.spy(new HookControlImpl<>(null, proxy, control, instantiator, supplier));
