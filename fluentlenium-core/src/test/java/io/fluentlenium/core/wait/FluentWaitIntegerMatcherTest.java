...
import io.fluentlenium.core.FluentDriver;import io.fluentlenium.core.conditions.RectangleConditions;import io.fluentlenium.core.conditions.WebElementConditions;import io.fluentlenium.core.domain.FluentWebElement;import io.fluentlenium.core.FluentDriver;
...
public class FluentWaitIntegerMatcherTest {
    ...
    public void testInteger() {
        ...
        rectangleConditions.x().verify(input -> input == 1);

        rectangleConditions.x().not().verify(input -> input != 1);

        rectangleConditions.not().x().not().verify(input -> input == 1);
