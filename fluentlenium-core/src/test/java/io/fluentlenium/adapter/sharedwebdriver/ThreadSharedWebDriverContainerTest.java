...
public class ThreadSharedWebDriverContainerTest implements Supplier<WebDriver> {
    ...
    public void getOrCreateDriverWithSameClassSameTestNamesDifferentThreadCreatesDistinctInstances()
        ...
        SharedMutator.EffectiveParameters<?> parameters = new SharedMutator.EffectiveParameters<>(Object.class, "test", DriverLifecycle.THREAD);
    ...
    public void getOrCreateDriverWithSameThreadDifferentTestClassCreatesDistinctInstances()
            throws ExecutionException, InterruptedException {
        SharedMutator.EffectiveParameters<?> parameters1 = new SharedMutator.EffectiveParameters<>(Object.class, "test", DriverLifecycle.THREAD);
        SharedMutator.EffectiveParameters<?> parameters2 = new SharedMutator.EffectiveParameters<>(String.class, "test", DriverLifecycle.THREAD);
    ...
    public void getOrCreateDriverWithSameThreadDifferentTestNameCreatesDistinctInstances()
            throws ExecutionException, InterruptedException {
        SharedMutator.EffectiveParameters<?> parameters1 = new SharedMutator.EffectiveParameters<>(Object.class, "test", DriverLifecycle.THREAD);
        SharedMutator.EffectiveParameters<?> parameters2 = new SharedMutator.EffectiveParameters<>(Object.class, "test2", DriverLifecycle.THREAD);
