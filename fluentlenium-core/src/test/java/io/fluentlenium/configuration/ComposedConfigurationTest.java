...
public class ComposedConfigurationTest {
    ...
    public void before() {
        ...
        configurationProperties1 = Mockito.mock(ConfigurationProperties.class, configurationReadAnswer);
        configurationProperties2 = Mockito.mock(ConfigurationProperties.class, configurationReadAnswer);
        configurationProperties3 = Mockito.mock(ConfigurationProperties.class, configurationReadAnswer);
