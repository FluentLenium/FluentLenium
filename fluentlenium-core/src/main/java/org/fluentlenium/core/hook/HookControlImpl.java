...
public class HookControlImpl<T> implements HookControl<T> {
     ...
     */
    public HookControlImpl(T self, Object proxy, FluentControl control,
            ComponentInstantiator instantiator, Supplier<T> noHookInstanceSupplier) {
        this.self = self;
        this.proxy = proxy;
     ...
     */
    protected void applyHooks(Object proxy, HookChainBuilder hookChainBuilder,
