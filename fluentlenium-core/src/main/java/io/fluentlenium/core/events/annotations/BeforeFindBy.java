...
import io.fluentlenium.core.events.EventsRegistry;import io.fluentlenium.core.events.FindByListener;import io.fluentlenium.core.events.FindByListener;
 ...
 *
 * @see EventsRegistry#beforeFindBy(FindByListener)
 */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
public @interface BeforeFindBy {
    /**
