...
import static io.fluentlenium.utils.ReflectionUtils.getMethod;

import io.fluentlenium.utils.ReflectionUtils;import org.openqa.selenium.StaleElementReferenceException;
...
public abstract class AbstractLocatorAndInvocationHandler<T> extends AbstractLocatorHandler<T> implements InvocationHandler {
    private static final Method TO_STRING = ReflectionUtils.getMethod(Object.class, "toString");
    private static final Method EQUALS = ReflectionUtils.getMethod(Object.class, "equals", Object.class);
    private static final Method HASH_CODE = ReflectionUtils.getMethod(Object.class, "hashCode");
